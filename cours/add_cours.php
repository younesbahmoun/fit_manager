...
<head>
    ...
    <title>Ajouter un cours - SportFit Manager</title>
    ...
    <main>
        <div class="container">
            <div class="page-title">
                <h1><i class="fas fa-calendar-plus"></i> Ajouter un nouveau cours</h1>
            ...
            <div class="form-container">
                <form action="save_cours.php" method="POST">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="duree" name="duree" min="15" max="180" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" rows="4" placeholder="Description du cours..."></textarea>
                    </div>
